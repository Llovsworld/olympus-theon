            ...
            <section className="programs-final-cta">
                <div className="container">
                    <ScrollReveal variant="scale">
                        <h2 className="final-cta-title">¿LISTO PARA LA TRANSFORMACIÓN?</h2>
                        <p className="final-cta-text">
                            No aceptamos a todos. Si estás preparado para comprometerte completamente con tu transformación, da el primer paso.
                        </p>
                        <a href="https://wa.me/34608961701?text=Quiero%20comenzar%20mi%20transformación%20con%20Olympus%20Theon" target="_blank" rel="noopener noreferrer" className="btn-whatsapp" style={{ marginTop: '2rem' }}>
                            <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="whatsapp-icon">
